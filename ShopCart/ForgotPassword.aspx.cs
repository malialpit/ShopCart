        ...
        protected void btnResetPass_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["ShopCart"].ConnectionString))
            {
                ...
                if (dt.Rows.Count != 0)
                {
                    ...
                    MailMessage PassRecMail = new MailMessage("arpitmali888@gmail.com", ToEmailAddress);
                    ...
                    using (SmtpClient client = new SmtpClient())
                    {
                        ...
                        client.Credentials = new NetworkCredential("arpitmali888@gmail.com", "Exclu$Ive@98250");
